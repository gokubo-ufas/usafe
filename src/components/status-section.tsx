        ...
        return (
          <div key={emp.employee_number} className="px-4 py-2.5 space-y-1">
            ...
            <div className="grid grid-cols-3 gap-x-1 text-[11px]">
              <span><span className="text-gray-400">本人：</span><span className="font-semibold text-gray-700">{selfVal}</span></span>
              <span><span className="text-gray-400">家族：</span><span className="font-semibold text-gray-700">{familyVal}</span></span>
              <span><span className="text-gray-400">業務：</span><span className="font-semibold text-gray-700">{workVal}</span></span>
            </div>
            {r?.comment && (
              <div className="text-xs text-gray-400">コメント：{r.comment}</div>
            )}
          </div>
        )
      })}
